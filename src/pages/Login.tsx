      ...
      <main className="container flex items-center justify-center py-20">
        <div className="glass-card rounded-2xl p-8 w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="font-heading text-2xl font-bold text-foreground mb-2">Mokytojo prisijungimas</h1>
            <p className="text-sm text-muted-foreground">Prisijunkite, kad galėtumėte rezervuoti kabinetus</p>
          </div>
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="email" placeholder="Įveskite el. paštą" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-9" />
              </div>
            </div>
            <div className="space-y-2">
